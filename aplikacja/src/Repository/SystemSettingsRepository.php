...
class SystemSettingsRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(SystemSettings $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(SystemSettings $entity, bool $flush = true): void
    {
